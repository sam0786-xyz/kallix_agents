# =========================================================
# 🧠 Kallix Ecommerce Lead & Audio Capture API
# =========================================================
...
web_app = FastAPI(title="Kallix Ecommerce Lead API")
...
async def capture_lead(request: Request):
    ...
    try:
        ...
        # Get Ecommerce Webhook
        GOOGLE_SHEET_WEBHOOK_ECOMMERCE = os.environ.get("GOOGLE_SHEET_WEBHOOK_ECOMMERCE")

        if GOOGLE_SHEET_WEBHOOK_ECOMMERCE:
            resp = requests.post(
                GOOGLE_SHEET_WEBHOOK_ECOMMERCE,
                json=lead,
                timeout=5,
            ...
            logger.warning("⚠️ GOOGLE_SHEET_WEBHOOK_ECOMMERCE not set — skipped sending to Sheets.")
